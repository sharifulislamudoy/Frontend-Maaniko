          ...
          >
            <div className="flex h-[72px] shrink-0 items-center justify-between border-b border-[#dce3ec] px-5">
              ...
              <button
                ...
                aria-label={t("cart.close")}
                onClick={closeCart}
                className="inline-flex size-10 items-center justify-center rounded-full text-[#062a54] transition-colors hover:bg-[#fff4f6] hover:text-[#FC5689]"
              >
                <X className="size-5" />
              </button>
            </div>
              ...
              <>
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start gap-2">
                          <Link
                            href={product.href ?? `/products/${product.slug}`}
                            onClick={closeCart}
                            className="line-clamp-2 flex-1 text-sm font-bold leading-5 text-[#062a54] hover:text-[#FC5689]"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex size-8 shrink-0 items-center justify-center rounded-full text-slate-400 hover:bg-[#fff4f6] hover:text-[#FC5689]"
                          >
                        ...
                        <div className="mt-2 inline-flex h-9 items-center rounded-lg border border-[#dce3ec]">
                          <button
                            ...
                            className="inline-flex h-full w-9 items-center justify-center text-[#062a54] hover:text-[#FC5689]"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex h-full w-9 items-center justify-center text-[#062a54] hover:text-[#FC5689] disabled:cursor-not-allowed disabled:opacity-35"
                          >
                ...
                <div className="shrink-0 border-t border-[#dce3ec] bg-white p-5">
                  ...
                  <Link
                    href="/checkout"
                    onClick={closeCart}
                    className="flex h-12 w-full items-center justify-center rounded-xl bg-[#FC5689] text-sm font-extrabold text-white transition-colors hover:bg-[#03A7FD]"
                  >
                    {t("cart.checkout")}
                  </Link>
                </div>
