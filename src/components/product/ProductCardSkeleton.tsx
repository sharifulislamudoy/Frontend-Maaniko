export default function ProductCardSkeleton() {
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-[20px] border border-[#dce3ec] bg-white shadow-[0_12px_34px_rgba(6,42,84,0.08)]">
      ...
      <div className="flex flex-1 flex-col space-y-2.5 p-4">
        ...
        <div className="mt-auto flex items-center justify-between border-t border-[#dce3ec]/80 pt-2.5">
