...
import type { LanguageCode, LanguageOption } from "@/types/localization";
  ...
  bn: {
    translation: {
      ...
      cart: {
        ...
        emptyDescription: "আপনার পছন্দের পণ্য কার্টে যোগ করলে এখানে দেখা যাবে।",
  ...
  en: {
    translation: {
      ...
      wishlist: {
        ...
        emptyDescription: "Tap the heart icon on a product to save it here.",
      ...
      cart: {
        ...
        emptyDescription: "Products you add to cart will appear here.",
