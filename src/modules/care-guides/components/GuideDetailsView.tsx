...
import type { DetailedCareGuideItem } from "@/modules/care-guides/types/careGuide";

type GuideDetailsViewProps = {
  guide: DetailedCareGuideItem;
};

export default function GuideDetailsView({ guide }: GuideDetailsViewProps) {
                ...
                >
                  ...
                  <ul className="mt-4 space-y-3">
                    {section.points.map((point, index) => (
                      <li
                        key={`${guide.slug}-${text(section.title)}-${index}`}
