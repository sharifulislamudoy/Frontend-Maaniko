      ...
      <div className="service-marquee-track flex w-max items-center">
        {[0, 1].map((copyIndex) => (
          <div
            ...
            className={`service-marquee-group flex min-h-10 min-w-[100vw] shrink-0 items-center justify-around gap-8 px-4 sm:min-h-11 sm:gap-12 sm:px-8${
              copyIndex === 1 ? " service-marquee-copy" : ""
            }`}
          >
